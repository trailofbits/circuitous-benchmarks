...
namespace circ::bench
{
    ...
    namespace detail
    {
        circuit_ptr make_circuit(auto &&bytes) {
    ...
    static inline circuit_ptr make_circuit(instance_t instance) {
        return detail::make_circuit(instance.bytes);
    }

    static inline circuit_ptr make_circuit(ciff_file_t ciff_file) {
